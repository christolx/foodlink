    ...
    if (role === "receiver") {
      ...
      return [
        ...
        },
        {
          ...
          panel: "notifications" as SidePanelType,
        },
      ];
    }
    if (role === "volunteer") {
...
export function DashboardTopbar({
  ...
  if (data.user.role === "volunteer") {
    ...
    return (
      <header
        className="mb-4 hidden gap-4 border-b border-[#ded7c9] pb-4 lg:grid xl:grid-cols-[max-content_1fr] xl:items-center"
  ...
  return (
    <header
      className="mb-4 grid gap-4 bg-transparent pt-1 md:mx-0 md:rounded-xl md:border md:border-[#ded7c9] md:bg-[#fffdf8]/70 md:px-5 md:py-4 md:grid-cols-[1fr_auto] md:items-center"
      id="dashboard-title"
    >
