...
export const input =
  "min-h-10 w-full rounded-[0.65rem] border border-[#cfc8ba] bg-[#fffdf8] px-3 py-2 text-base font-bold text-[#111a14] outline-none transition placeholder:text-[#7a817b] focus:border-[#116b35] focus:ring-2 focus:ring-[#116b35]/15";
