...
export function ProposalQueue({
  ...
  async function openChatWithVolunteer(volunteerId: string) {
    const conv = await getOrCreateConversation(token, volunteerId);
                ...
                >
                  ...
                  <div className="grid gap-3 sm:col-start-2">
                    ...
                    >
                      ...
                      {viewerRole === "donor" && myUserId && proposal.volunteerId ? (
                        <button
                          className={cx(ghostButton, "min-h-11 px-2 text-xs !text-[#14733a]")}
                          type="button"
