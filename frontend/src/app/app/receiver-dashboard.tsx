      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[7rem_1fr_auto] lg:items-center">
        ...
        <div className="grid gap-3 justify-self-start lg:justify-self-end">
          ...
          {proposal.volunteerId && (
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-md border border-[#9eb69f] bg-[#e9f4e3] px-3 py-1.5 text-xs font-black text-[#064c25]"
              onClick={(e) => { e.stopPropagation(); void openChat(); }}
            >
